...
export const metadata: Metadata = {
  ...
  description: "Terms of service for NameBlooms.",
...
export default function TermsPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        Welcome to NameBlooms. By accessing or using our website at nameblooms.com, you agree to be bound by these
      ...
      <p>
        NameBlooms provides baby name data, meanings, origins, and popularity trends for informational and educational
      ...
      <p>
        ...
        sourced from publicly available datasets, including the U.S. Social Security Administration. Users should
      ...
      <p>
        The content, design, and layout of this website are the property of NameBlooms and are protected by
        copyright and other intellectual property laws. You may not reproduce, distribute, or create derivative works
      ...
      <p>
        To the fullest extent permitted by law, NameBlooms shall not be liable for any indirect, incidental, special,
