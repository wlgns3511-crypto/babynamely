...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
      <head>
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-QEY3B4XMBB" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-QEY3B4XMBB');` }} />
          ...
          <div className="max-w-5xl mx-auto px-4 py-6 text-sm text-slate-500">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs">
                ...
                <a href="https://tariffpeek.com" className="hover:text-blue-600">HS Codes <p className="mt-1">&copy;amp; Tariffs</a>
              </div>
            </div>
            <p className="mt-1">\<p className="mt-1">&copy;copy; {new Date().getFullYear()} {SITE_NAME}. All rights reserved.</p>
          </div>
        </footer>
      </body>
    </html>
