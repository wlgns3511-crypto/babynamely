...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for NameBlooms.",
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        ...
        <a href="https://www.google.com/settings/ads" className="text-purple-600 hover:underline" target="_blank" rel="noopener noreferrer">
          Google Ads Settings
        </a>{" "}or visit{" "}
        <a href="https://www.aboutads.info/choices/" className="text-purple-600 hover:underline" target="_blank" rel="noopener noreferrer">www.aboutads.info</a>.
      </p>
